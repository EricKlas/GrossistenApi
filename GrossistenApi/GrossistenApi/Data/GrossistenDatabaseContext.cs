...
namespace GrossistenApi.Data
{
    ...
    public class GrossistenApiDatabaseContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            products.Add(new Product { Id = 2, ArticleNumber = "5012345678900", Title = "Jeans", Description = "Blå jeans, normal passform", Size = "M", Price = 499, Category = "Kläder", Quantity = 80, ShowInAvailableToPurchase = true, ShowInStock = true, ShowOnReceipt = true, ReceiptId = 2 });
            ...
            products.Add(new Product { Id = 4, ArticleNumber = "6012345678901", Title = "Hoodie", Description = "Grå hoodie", Size = "M", Price = 599, Category = "Kläder", Quantity = 40, ShowInAvailableToPurchase = true, ShowInStock = true, ShowOnReceipt = true, ReceiptId = 4 });
            ...
            products.Add(new Product { Id = 6, ArticleNumber = "8001234567890", Title = "Klocka", Description = "Analog klocka", Size = "25 cm", Price = 1299, Category = "Accessoarer", Quantity = 30, ShowInAvailableToPurchase = true, ShowInStock = true, ShowOnReceipt = true, ReceiptId = 6 });
            products.Add(new Product { Id = 7, ArticleNumber = "9001234567891", Title = "Bärbar dator", Description = "33 cm ultrabook", Size = "33 cm", Price = 9999, Category = "Elektronik", Quantity = 0, ShowInAvailableToPurchase = false, ShowInStock = false, ShowOnReceipt = false, ReceiptId = null });
            ...
            products.Add(new Product { Id = 10, ArticleNumber = "1001234567894", Title = "Solglasögon", Description = "UV-skydd", Size = "52 mm", Price = 399, Category = "Accessoarer", Quantity = 75, ShowInAvailableToPurchase = false, ShowInStock = true, ShowOnReceipt = false, ReceiptId = null });
            products.Add(new Product { Id = 11, ArticleNumber = "1101234567895", Title = "Bok", Description = "The Great Gatsby", Size = "13×20 cm", Price = 149, Category = "Böcker", Quantity = 100, ShowInAvailableToPurchase = true, ShowInStock = true, ShowOnReceipt = true, ReceiptId = 1 });
            products.Add(new Product { Id = 12, ArticleNumber = "1201234567896", Title = "Schackspel", Description = "Träschackspel", Size = "40×40 cm", Price = 349, Category = "Leksaker", Quantity = 20, ShowInAvailableToPurchase = true, ShowInStock = true, ShowOnReceipt = false, ReceiptId = 2 });
            products.Add(new Product { Id = 13, ArticleNumber = "1301234567897", Title = "Actionfigur", Description = "Superhjältefigur", Size = "15 cm", Price = 249, Category = "Leksaker", Quantity = 60, ShowInAvailableToPurchase = true, ShowInStock = true, ShowOnReceipt = true, ReceiptId = 3 });
            products.Add(new Product { Id = 14, ArticleNumber = "1401234567898", Title = "Bestickset", Description = "24-delars set i rostfritt stål", Size = "30×20×5 cm", Price = 599, Category = "Hem", Quantity = 80, ShowInAvailableToPurchase = true, ShowInStock = true, ShowOnReceipt = false, ReceiptId = 4 });
            products.Add(new Product { Id = 15, ArticleNumber = "1501234567899", Title = "Skrivbordslampa", Description = "LED-skrivbordslampa", Size = "45 cm", Price = 349, Category = "Hem", Quantity = 35, ShowInAvailableToPurchase = true, ShowInStock = true, ShowOnReceipt = true, ReceiptId = 5 });
            products.Add(new Product { Id = 16, ArticleNumber = "1601234567800", Title = "Parfym", Description = "Blommig doft 50 ml", Size = "50 ml", Price = 799, Category = "Skönhet", Quantity = 0, ShowInAvailableToPurchase = true, ShowInStock = false, ShowOnReceipt = true, ReceiptId = 6 });
            products.Add(new Product { Id = 17, ArticleNumber = "1701234567801", Title = "Hörlurar", Description = "Trådlösa over-ear", Size = "15×18 cm", Price = 1299, Category = "Elektronik", Quantity = 45, ShowInAvailableToPurchase = true, ShowInStock = true, ShowOnReceipt = true, ReceiptId = 7 });
            products.Add(new Product { Id = 18, ArticleNumber = "1801234567802", Title = "Yogamatta", Description = "Halkfri 6 mm", Size = "183×61 cm", Price = 299, Category = "Sport", Quantity = 0, ShowInAvailableToPurchase = true, ShowInStock = false, ShowOnReceipt = true, ReceiptId = 8 });
            products.Add(new Product { Id = 19, ArticleNumber = "1901234567803", Title = "Tält", Description = "Tält för 2 personer", Size = "210×140×110 cm", Price = 1599, Category = "Utomhus", Quantity = 15, ShowInAvailableToPurchase = false, ShowInStock = true, ShowOnReceipt = true, ReceiptId = 9 });
            products.Add(new Product { Id = 20, ArticleNumber = "2101234567804", Title = "Hundleksak", Description = "Hållbar tuggleksak", Size = "15×5 cm", Price = 129, Category = "Husdjur", Quantity = 90, ShowInAvailableToPurchase = true, ShowInStock = true, ShowOnReceipt = true, ReceiptId = 10 });
            ...
            products.Add(new Product { Id = 24, ArticleNumber = "2501234567808", Title = "Smartphone", Description = "6,5\" skärm, 128GB", Size = "16×7,5×0,8 cm", Price = 5999, Category = "Elektronik", Quantity = 25, ShowInAvailableToPurchase = true, ShowInStock = true, ShowOnReceipt = true, ReceiptId = null });
            ...
            products.Add(new Product { Id = 26, ArticleNumber = "2701234567810", Title = "Kokbok", Description = "Vegetariska recept", Size = "18×24 cm", Price = 249, Category = "Böcker", Quantity = 80, ShowInAvailableToPurchase = true, ShowInStock = true, ShowOnReceipt = true, ReceiptId = null });
            ...
            products.Add(new Product { Id = 30, ArticleNumber = "3101234567814", Title = "Sovsäck", Description = "Lättvikts för camping", Size = "210×75 cm", Price = 699, Category = "Utomhus", Quantity = 20, ShowInAvailableToPurchase = true, ShowInStock = true, ShowOnReceipt = true, ReceiptId = null });
            ...
            products.Add(new Product { Id = 35, ArticleNumber = "3601234567819", Title = "Bluetooth-högtalare", Description = "Portabel, vattentät", Size = "15×8×7 cm", Price = 799, Category = "Elektronik", Quantity = 45, ShowInAvailableToPurchase = true, ShowInStock = true, ShowOnReceipt = true, ReceiptId = null });
            ...
            products.Add(new Product { Id = 37, ArticleNumber = "3801234567821", Title = "Roman", Description = "Moderna klassiker", Size = "12×19 cm", Price = 179, Category = "Böcker", Quantity = 90, ShowInAvailableToPurchase = true, ShowInStock = true, ShowOnReceipt = true, ReceiptId = null });
            ...
            products.Add(new Product { Id = 40, ArticleNumber = "4101234567824", Title = "Hantelset", Description = "2×5 kg, justerbart", Size = "25 cm", Price = 899, Category = "Sport", Quantity = 25, ShowInAvailableToPurchase = true, ShowInStock = true, ShowOnReceipt = true, ReceiptId = null });
